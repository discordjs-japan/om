...
FROM node:20.12.0-bookworm@sha256:bf0ef0687ffbd6c7742e1919177826c8bf1756a68b51f003dcfe3a13c31c65fe AS deps
...
FROM --platform=$BUILDPLATFORM node:20.12.0-bookworm@sha256:bf0ef0687ffbd6c7742e1919177826c8bf1756a68b51f003dcfe3a13c31c65fe AS builder
...
FROM --platform=$BUILDPLATFORM node:20.12.0-bookworm@sha256:bf0ef0687ffbd6c7742e1919177826c8bf1756a68b51f003dcfe3a13c31c65fe AS models
WORKDIR /app
...
FROM gcr.io/distroless/nodejs20-debian12:nonroot@sha256:895ef5fc78c94e68f210b6cfe22a7c693a2b30dab9466cd63c297821ef96c8fa AS runner
WORKDIR /app
